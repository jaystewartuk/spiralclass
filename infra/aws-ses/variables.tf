variable "aws_region" {
  type        = string
  description = "SES is regional. us-east-1 default per infra/aws-ses/README.md Part B (most mature region, cheapest, no meaningful latency difference for transactional email to inboxes in the Americas)."
  default     = "us-east-1"
}
