...
export default defineConfig({
  ...
  use: {
    ...
    // The E2E and a11y suites pin es because they assert Spanish copy. This
  ...
  projects: [
    ...
    // Pinned to es because tests/e2e/_helpers/better-auth.ts locates the
    ...
    { name: "setup", testMatch: /auth\.setup\.ts/, use: { locale: "es" } },
