...
describe("privacy policy", () => {
  ...
  it("describes only the UK GDPR regime", () => {
    // A bilingual notice drifts toward Spanish-language privacy vocabulary
    // (`aviso`, ARCO rights) that UK GDPR does not use. A
    ...
    for (const term of ["arco", "aviso de privacidad"]) {
