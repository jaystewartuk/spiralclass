...
//
// From the 2026-08-05 product review: the seller-of-record disclaimer in
...
// since it's a legal statement, not just a payment-rail one.
...
describe("CheckoutForm — seller disclaimer", () => {
  ...
  it("shows the transfer disclaimer, keeping the seller-of-record sentence", () => {
