...
function item(over: Partial<Item> = {}): Item {
  return {
    ...
    status: "planned",
    reason: { code: "best_community", community: "Riverside Expats", students: 2 },
    communityName: "Riverside Expats",
    studentName: null,
...
describe("the next action", () => {
  ...
  it("leads with the reason, not the content type", () => {
    ...
    expect(html).toContain("Riverside Expats has already brought you 2 students.");
    const heading = html.indexOf("Riverside Expats has already brought you 2 students.");
    ...
    expect(html).toMatch(/<h3[^>]*>Riverside Expats has already brought you 2 students\.<\/h3>/);
  });
...
describe("the booking-page card", () => {
  const signals = (over: Partial<PageSignals> = {}): PageSignals => ({
    hasPhoto: true,
    headline: "Learn Spanish in Valencia",
    bio: "x".repeat(200),
    packageCount: 2,
    testimonialCount: 1,
    hasIntroVideo: true,
