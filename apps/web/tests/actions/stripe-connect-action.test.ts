...
describe("startStripeConnect", () => {
  ...
  it("MINTS an account for the launch market and BR — reversed at D-143", async () => {
    ...
    // could not Transfer to a connected account outside the circle, so minting one stranded her.
