...
//   - rendered with Intl.NumberFormat('es', currency MXN)

describe("formatMinorUnits", () => {
  it("formats integer minor units with es MXN currency conventions and an MXN suffix", () => {
  ...
  it("renders the currency symbol, grouping, and MXN suffix consistent with es retail copy", () => {
