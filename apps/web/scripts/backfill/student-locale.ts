// Re-stamp roster students whose `locale` was hardcoded to es at creation.
//
// Both student-creation paths used to hardcode `locale: "es"` regardless of
...
// English-speaking student stamped es gets Spanish class reminders and
...
//   pnpm backfill:student-locale --teacher <teacherId> --to es --commit
