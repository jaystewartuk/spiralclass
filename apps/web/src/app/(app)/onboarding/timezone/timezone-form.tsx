...
export function TimezoneForm({
  ...
  // locale or the country: neither is evidence of what she teaches (a Spanish-speaking
  ...
  // teacher hasn't chosen yet — never override a real pick. Mirrors the
  // timezone auto-detect above.
  useEffect(() => {
