...
import { intlLocale, countryOptions } from "@spiralclass/shared";
...
export default async function AccountSettingsPage({
  ...
  const memberSince = new Intl.DateTimeFormat(intlLocale(locale), {
    month: "long",
    year: "numeric",
        ...
        >
          ...
          >
            <MyDetailsForm
              ...
              initialPhoneCountry={teacher.country ?? undefined}
