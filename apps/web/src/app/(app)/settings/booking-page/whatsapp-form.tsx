...
export function WhatsAppForm({
  ...
  const initialSplit = initialWhatsapp
    ? splitE164(initialWhatsapp, initialCountry ?? undefined)
    : null;
  const [country, setCountry] = useState(initialSplit?.country ?? initialCountry ?? "");
