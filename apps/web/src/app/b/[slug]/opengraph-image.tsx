...
// previews renders the buyer-facing spelling — two spellings of one price, on the asset a
...
// es catalog's tagline verbatim, so a link shared to Facebook rendered a
