...
//
//   * The rail switcher led. A stranger who has just decided to spend 1,300 pesos
...
export function PurchaseFlow({
  ...
  // no Stripe (a teacher offering both Wise and SPEI).
  ...
  const money = (minorUnits: number) =>
    formatPriceForBuyer(minorUnits, selected.currency, locale, selected.currency);
                  ...
                  >
                    ...
                    <div className="text-right">
                      <div className="font-semibold tabular-nums">
                        {formatPriceForBuyer(price, tpl.currency, locale, tpl.currency)}
                      </div>
