...
// funnel renders the buyer-facing spelling — two spellings of the one number the buyer is
// checking hardest.
import {
  formatPriceForBuyer,
    ...
    >
      ...
      >
        {pending
          ...
          : ctaCopy(t, method, formatPriceForBuyer(displayPrice, currency, locale, currency))}
      </Button>
      {method === "stripe" && (
      ...
      {/* Legal seller-of-record statement — rail-aware because the
