...
export async function saveTimezoneAction(
  ...
  await prisma.teacher.update({
    ...
    data: {
      ...
      // Only overwrite the currency when sent, and only before
...
export async function saveTemplatesAction(
  ...
  // was UNREACHABLE — the first live teacher's booking page advertised
  ...
  const wiseSplitAvailable = teacher.country != null && isConnectCountrySupported(teacher.country);
