...
describe("normalizeE164", () => {
  ...
  it("passes a country hint through the re-export to resolve another calling code", () => {
...
describe("phoneMatchVariants", () => {
  it("returns the canonical +digits form for a non-+52 number", () => {
    expect(phoneMatchVariants("+14155550123")).toEqual(["+14155550123"]);
  });

  it("reconciles a modern +52 number (+52 + 10 digits) with the legacy 1 form", () => {
  ...
  it("reconciles a legacy +52 number (+521 + 10 digits) with the modern form", () => {
  ...
  it("does not invent a 1-variant for a +52 number of unexpected length", () => {
