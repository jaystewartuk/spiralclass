...
const CHANNEL_LABELS: Record<string, Record<AppLocale, string>> = {
  facebook: { es: "Facebook", en: "Facebook", fr: "Facebook" },
  reddit: { es: "Reddit", en: "Reddit", fr: "Reddit" },
  whatsapp: { es: "WhatsApp", en: "WhatsApp", fr: "WhatsApp" },
  instagram: { es: "Instagram", en: "Instagram", fr: "Instagram" },
  referral: { es: "Recomendaciones", en: "Referrals", fr: "Recommandations" },
  direct: { es: "Directo", en: "Direct", fr: "Direct" },
};
