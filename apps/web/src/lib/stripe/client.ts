...
export type CreateConnectedAccountInput = {
  ...
  // can offer her students — one account can present OXXO and SPEI, a
...
// 2026-08-31, one teacher's checkout returns ["card", "oxxo", "link"].
export type CreateCheckoutSessionInput = {
  ...
  // (`mx_bank_transfer`, for instance). Omit it and the session simply doesn't
              ...
              configuration: {
                merchant: {
                  capabilities: {
                    ...
                    // Her country's local methods — OXXO and SPEI for one
          ...
          stripe.checkout.sessions.create(
            {
              ...
              // Bank transfer (SPEI, for instance) is the one method dynamic
              ...
              // MERCHANT's country, so one teacher's checkout can present
...
// created under the pre-D-58 platform entity — is permanently
