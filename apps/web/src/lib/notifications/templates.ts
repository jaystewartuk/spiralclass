...
// Supported languages for outbound copy (Student.locale 'es' → 'es',
// 'en' → 'en'; the email renderer branches on these codes). The list, the type,
// and the locale→code bridge all live in the shared locale registry now,
...
export type TemplateVariables = {
  ...
  student_acquisition_plan_teacher: {
    ...
    // Riverside Expats"). This is what makes the nudge a plan rather than a nag.
    firstAction: string;
