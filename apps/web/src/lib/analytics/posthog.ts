...
export type ServerEvent = WithSessionId<
  ...
  | {
      ...
      properties: {
        ...
        isOwner: boolean;
        // Our own request classification (lib/marketing/bots.ts) — the user
        // agent, and the purpose header a prefetch sends — NOT PostHog's
        // `$virt_is_bot`. That virtual property reads true on 100%
