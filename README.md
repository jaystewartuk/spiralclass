...
not go wrong twice. The 127 decision records in
...
There are 801 test files across five layers — unit, real-database integration,
...
| [`docs/decisions/`](docs/decisions/)       | **127 decision records.** Current policy, not history — several reverse an earlier one |
