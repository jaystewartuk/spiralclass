...
first decision and `D-170` the most recent. A gap means a record was removed,
...
| [D-175](./D-175.md) | **Vercel returns as a second production target that holds no domain** — the target, not the coupling         |
...
| [D-89](./D-89.md)   | Production cutover executed; Vercel and Supabase decommissioned       | Active (Vercel target back → D-175)  |
...
| [D-175](./D-175.md) | Vercel is a second production target; it holds no domain              | Decided; built, never served         |
