...
// first draft of this file — `es` are both twelve-hour. CLDR puts es on
 ...
 *
 *   new Intl.DateTimeFormat(intlLocale(locale), { timeZone, weekday: "short", ...timeOptionsFor(locale) })
 */
