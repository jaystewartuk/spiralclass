...
export const CONTENT_KIND_SPECS: Record<MarketingContentKind, ContentKindSpec> = {
  intro: {
    kind: "intro",
    family: "direct",
    label: { es: "Preséntate", en: "Introduce yourself", fr: "Présentez-vous" },
    summary: {
      es: "Quién eres, a quién enseñas y cómo trabajas.",
  ...
  availability: {
    kind: "availability",
    family: "direct",
    label: { es: "Anuncia tu cupo", en: "Announce open spots", fr: "Annoncez vos créneaux" },
    summary: {
      es: "Los horarios que tienes libres esta semana.",
  ...
  package_offer: {
    kind: "package_offer",
    family: "direct",
    label: { es: "Presenta un paquete", en: "Present a package", fr: "Présentez un forfait" },
    summary: {
      es: "Qué incluye un paquete y para quién es.",
  ...
  tip: {
    kind: "tip",
    family: "educational",
    label: { es: "Un consejo útil", en: "A useful tip", fr: "Un conseil utile" },
    summary: {
      es: "Algo que un aprendiz puede usar hoy mismo.",
  ...
  common_mistake: {
    kind: "common_mistake",
    family: "educational",
    label: { es: "Un error común", en: "A common mistake", fr: "Une erreur fréquente" },
    summary: {
      es: "El error que casi todos cometen, y el arreglo.",
  ...
  mini_lesson: {
    kind: "mini_lesson",
    family: "educational",
    label: { es: "Mini lección", en: "Mini lesson", fr: "Mini-leçon" },
    summary: {
      es: "Una idea explicada de principio a fin.",
  ...
  phrase_of_the_day: {
    ...
    family: "educational",
    label: { es: "Frase del día", en: "Phrase of the day", fr: "Expression du jour" },
    summary: {
      es: "Una expresión real que se usa de verdad.",
  ...
  discussion_question: {
    ...
    family: "engagement",
    label: {
      es: "Pregunta a la comunidad",
      en: "Ask the community",
      fr: "Question à la communauté",
    },
    summary: {
      es: "Una pregunta que la gente quiere contestar.",
  ...
  this_or_that: {
    kind: "this_or_that",
    family: "engagement",
    label: { es: "¿Cuál dirías?", en: "Which would you say?", fr: "Lequel diriez-vous ?" },
    summary: {
      es: "Dos opciones, una correcta. Invita a responder.",
  ...
  testimonial: {
    ...
    family: "social_proof",
    label: {
      es: "Comparte una reseña",
      en: "Share a testimonial",
      fr: "Partagez un témoignage",
    },
    summary: {
      es: "Las palabras de un alumno, con contexto.",
  ...
  student_story: {
    ...
    family: "social_proof",
    label: {
      es: "Una historia de progreso",
      en: "A progress story",
      fr: "Une histoire de progrès",
    },
    summary: {
      es: "De dónde salió un alumno y a dónde llegó.",
  ...
  referral_ask: {
    ...
    family: "referral",
    label: {
      es: "Pide una recomendación",
      en: "Ask for a referral",
      fr: "Demandez une recommandation",
    },
    summary: {
      es: "Un mensaje corto para tus alumnos actuales.",
  ...
  community_reply: {
    ...
    family: "educational",
    label: { es: "Responde a alguien", en: "Reply to someone", fr: "Répondez à quelqu'un" },
    summary: {
      es: "Ayuda a alguien que ya preguntó algo.",
