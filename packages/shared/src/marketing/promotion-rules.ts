 ...
 * teacher west of Greenwich that Monday's window closed on Sunday evening. Callers pass
...
export function weekdayLabels(locale: AppLocale, style: "short" | "long" = "short"): string[] {
  ...
  // Greenwich every label slid back a day: a machine set to UTC-6 rendered
