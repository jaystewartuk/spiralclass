...
describe("planReasonText", () => {
  it("renders every reason shape in every locale without leaking a placeholder", () => {
    const reasons = [
      { code: "best_community", community: "Riverside Expats", students: 2 },
      { code: "promising_community", community: "Riverside Expats", enquiries: 3 },
      { code: "quiet_community", community: "Riverside Expats", days: 12 },
      { code: "untried_community", community: "Riverside Expats" },
      { code: "educational_first", community: "Riverside Expats" },
