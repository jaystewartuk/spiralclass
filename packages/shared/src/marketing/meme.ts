...
export const MEME_STYLE_SPECS: Record<MemeStyle, MemeStyleSpec> = {
  varied: {
    style: "varied",
    label: { es: "Variado", en: "Varied", fr: "Varié" },
    summary: {
      es: "Cambiamos el estilo en cada imagen para que no se repitan.",
  ...
  photo: {
    ...
    summary: {
      es: "Fotos reales de la vida diaria.",
  ...
  illustration: {
    style: "illustration",
    label: { es: "Ilustración", en: "Illustration", fr: "Illustration" },
    summary: {
      es: "Ilustración digital limpia y colorida.",
  ...
  bold_graphic: {
    style: "bold_graphic",
    label: { es: "Gráfico llamativo", en: "Bold graphic", fr: "Graphique audacieux" },
    summary: {
      es: "Formas simples y colores fuertes que se ven bien en miniatura.",
  ...
  retro: {
    style: "retro",
    label: { es: "Retro", en: "Retro", fr: "Rétro" },
    summary: {
      es: "Aire vintage: impresión antigua, película, carteles viejos.",
  ...
  hand_drawn: {
    style: "hand_drawn",
    label: { es: "Dibujado a mano", en: "Hand drawn", fr: "Dessiné à la main" },
    summary: {
      es: "Trazo suelto, como un cuaderno de apuntes.",
