...
export const PLATFORM_SPECS: Record<MarketingPlatform, PlatformSpec> = {
  facebook_group: {
    ...
    label: { es: "Grupo de Facebook", en: "Facebook group", fr: "Groupe Facebook" },
  ...
  reddit: {
    platform: "reddit",
    label: { es: "Comunidad de Reddit", en: "Reddit community", fr: "Communauté Reddit" },
  ...
  whatsapp: {
    platform: "whatsapp",
    label: { es: "WhatsApp", en: "WhatsApp", fr: "WhatsApp" },
  ...
  instagram: {
    platform: "instagram",
    label: { es: "Instagram", en: "Instagram", fr: "Instagram" },
    defaultPromoPolicy: "open",
    maxChars: 500,
    linkPlacement: "profile_only",
    imageAspect: "4:5",
  ...
  local: {
    platform: "local",
    label: { es: "Comunidad local", en: "Local community", fr: "Communauté locale" },
    defaultPromoPolicy: "open",
    maxChars: 500,
    linkPlacement: "inline",
    imageAspect: "1.91:1",
  ...
  other: {
    platform: "other",
    label: { es: "Otro canal", en: "Other channel", fr: "Autre canal" },
