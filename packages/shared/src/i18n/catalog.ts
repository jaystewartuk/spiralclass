...
// file (catalog.es.ts / catalog.en.ts / catalog.fr.ts) — split out of this
...
// A key into the catalog. Derived from the source locale (es); the guard
...
// "every registered locale → every StringKey". If a key is added to es
