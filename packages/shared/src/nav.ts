...
export const NAV_GROUP_LABELS: Record<NavGroupKey, NavLabel> = {
  main: { es: "Principal", en: "Main", fr: "Principal" },
  page: { es: "Tu página", en: "Your page", fr: "Votre page" },
  ...
  content: { es: "Materiales", en: "Materials", fr: "Supports" },
  config: { es: "Configuración", en: "Settings", fr: "Paramètres" },
  support: { es: "Soporte", en: "Support", fr: "Assistance" },
};
...
export const NAV_ITEMS: NavItem[] = [
  // ---- principal ----
  {
    key: "dashboard",
    group: "main",
    label: { es: "Panel", en: "Dashboard", fr: "Tableau de bord" },
  },
  {
    key: "calendar",
    group: "main",
    label: { es: "Calendario", en: "Calendar", fr: "Calendrier" },
  },
  {
    key: "classes",
    group: "main",
    label: { es: "Clases", en: "Classes", fr: "Cours" },
    description: {
      es: "Próximas, completar, cancelar, ajustar.",
  ...
  },
  {
    key: "students",
    group: "main",
    label: { es: "Alumnos", en: "Students", fr: "Élèves" },
    description: {
      es: "Saldos, vencimientos y precio personalizado.",
  ...
  },
  {
    key: "payments",
    group: "main",
    label: { es: "Pagos", en: "Payments", fr: "Paiements" },
    description: {
      es: "Recibos, parciales y reembolsos.",
  ...
  },
  {
    key: "messages",
    group: "main",
    label: { es: "Mensajes", en: "Messages", fr: "Messages" },
    description: {
      es: "Chat de voz y texto con tus alumnos.",
  ...
  },
  {
    key: "getStudents",
    group: "main",
    label: { es: "Consigue alumnos", en: "Get students", fr: "Trouvez des élèves" },
    description: {
      es: "Tu plan de la semana, contenido listo y resultados.",
  ...
  //      page," not buried in settings.
  {
    key: "bookingPage",
    group: "page",
    label: { es: "Editar tu página", en: "Edit your page", fr: "Modifier votre page" },
    description: {
      es: "El titular, la descripción y la foto de tu página pública.",
  ...
  },
  {
    key: "publicPage",
    group: "page",
    label: { es: "Ver página pública", en: "View public page", fr: "Voir la page publique" },
    description: {
      es: "Tu página de reservas tal como la ven tus alumnos. Se abre en tu navegador.",
  ...
  },
  {
    key: "leads",
    group: "page",
    label: { es: "Interesados", en: "Leads", fr: "Prospects" },
    description: {
      es: "Personas que te escribieron desde tu página.",
  ...
  },
  {
    ...
    description: {
      es: "Prueba social en tu página de reservas.",
  ...
  },
  {
    key: "discounts",
    group: "page",
    label: { es: "Códigos de descuento", en: "Discount codes", fr: "Codes de réduction" },
    description: {
      es: "Códigos promocionales para el pago.",
  ...
  },
  {
    key: "referrals",
    group: "page",
    label: { es: "Referidos", en: "Referrals", fr: "Parrainages" },
    description: {
      es: "Deja que tus alumnos traigan amigos por una recompensa.",
  ...
  },
  {
    ...
    key: "shareGroups",
    group: "page",
    label: { es: "Comunidades", en: "Communities", fr: "Communautés" },
    description: {
      es: "Dónde puedes llegar a futuros alumnos, y qué permite cada una.",
  ...
  // ---- contenido (Contenido) — teaching content, its own group ----
  {
    key: "materials",
    group: "content",
    label: { es: "Materiales", en: "Materials", fr: "Supports" },
    description: {
      es: "Biblioteca de recursos por nivel.",
  ...
  },
  {
    ...
    label: { es: "Etiquetas", en: "Tags", fr: "Étiquettes" },
    description: {
      es: "Categorías, formatos y temas para tus materiales y clases.",
  ...
  },
  {
    ...
    group: "content",
    label: { es: "Plantillas de clase", en: "Lesson templates", fr: "Modèles de cours" },
    description: {
      es: "Estructuras de clase reutilizables que la IA sigue al generar contenido.",
  ...
  },
  {
    key: "materialStyle",
    group: "content",
    label: { es: "Estilo con IA", en: "AI material style", fr: "Style des supports IA" },
    description: {
      es: "Tono y estilo que la IA usa al generar tus materiales.",
  ...
  },
  {
    key: "blockedDates",
    group: "config",
    label: { es: "Fechas bloqueadas", en: "Blocked dates", fr: "Dates bloquées" },
    description: {
      es: "Vacaciones, festivos y días libres.",
  ...
  },
  {
    key: "packages",
    group: "config",
    label: { es: "Paquetes", en: "Packages", fr: "Forfaits" },
  },
  {
    key: "paymentMethods",
    group: "config",
    label: { es: "Métodos de cobro", en: "Payment methods", fr: "Moyens de paiement" },
  },
  {
    key: "billing",
    group: "config",
    label: { es: "Suscripción", en: "Subscription", fr: "Abonnement" },
  },
  {
    key: "notifications",
    group: "config",
    label: { es: "Notificaciones", en: "Notifications", fr: "Notifications" },
  },
  {
    key: "account",
    group: "config",
    label: { es: "Cuenta", en: "Account", fr: "Compte" },
    description: {
      es: "Datos de la cuenta y eliminación.",
  ...
  // ---- soporte ----
  {
    key: "help",
    group: "support",
    label: { es: "Ayuda", en: "Help", fr: "Aide" },
    description: {
      es: "Paquetes, pagos, cancelaciones y más.",
  ...
  },
  {
    key: "privacy",
    group: "support",
    label: { es: "Aviso de privacidad", en: "Privacy notice", fr: "Avis de confidentialité" },
    external: true,
  },
  {
    key: "terms",
