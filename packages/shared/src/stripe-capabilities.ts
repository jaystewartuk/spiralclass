...
// present OXXO to a student in that country at any price, because offerable methods are
...
const LOCAL_PAYMENT_CAPABILITIES: Record<string, readonly string[]> = {
  // The first country this was built against, and the one that proves the
...
//
// SPEI and its Japanese equivalent reach Checkout as the
