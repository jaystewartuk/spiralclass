...
// UK-established (D-58). It replaced a hand-written bilingual notice whose controller and
// rights regime did not match a UK-established controller.
      ...
      },
      {
        ...
        rows: [
          ...
          },
          {
            ...
            data: "Speech audio and caption text while the feature is on",
            basis: "Consent",
          },
          {
