...
// es is the default locale; copy is written Spanish-first. Bodies carry a
...
const HEADER: { title: Copy; subtitle: Copy; progress: Copy; allDone: Copy } = {
  title: { es: "Crecer", en: "Grow", fr: "Développer" },
  subtitle: {
    es: "Pasos para llenar tu agenda.",
    en: "Steps to fill your schedule.",
    fr: "Des étapes pour remplir votre agenda.",
  },
  progress: {
    es: "{n} de {total} listos",
    en: "{n} of {total} done",
    fr: "{n} sur {total} terminés",
  },
  allDone: {
    es: "¡Listo! Estás haciendo todo para crecer.",
...
> = {
  payment: {
    ...
    todo: {
      es: "Conecta Stripe o Wise. Sin esto, no puedes cobrar tus clases.",
    ...
    todoWiseOnly: {
      es: "Conecta Wise. Sin esto, no puedes cobrar tus clases.",
      ...
      es: "Ya puedes recibir pagos por tus clases.",
      en: "You're set up to get paid for your classes.",
      fr: "Vous êtes prêt à être payé pour vos cours.",
    },
    cta: { es: "Configurar pagos", en: "Set up payments", fr: "Configurer les paiements" },
  ...
  profile: {
    ...
    todo: {
      es: "Agrega tu foto y una bio breve. Los alumnos reservan con quien pueden ver.",
      ...
      es: "Tu foto y tu bio ya están en tu página.",
      en: "Your photo and bio are live on your page.",
      fr: "Votre photo et votre bio sont en ligne sur votre page.",
    },
    cta: { es: "Editar perfil", en: "Edit profile", fr: "Modifier le profil" },
  ...
  testimonials: {
    title: { es: "Suma una reseña", en: "Add a testimonial", fr: "Ajoutez un témoignage" },
    todo: {
      es: "Pide a un alumno una frase y publícala. La prueba social convierte.",
    ...
    // {n} interpolated; plural handled per-locale in resolve().
      ...
      es: "Tienes {n} reseña{s} publicada{s} en tu página.",
      en: "You have {n} testimonial{s} live on your page.",
      fr: "Vous avez {n} témoignage{s} en ligne sur votre page.",
    },
    cta: { es: "Agregar reseña", en: "Add testimonial", fr: "Ajouter un témoignage" },
    action: { kind: "nav", nav: "testimonials" },
  },
  share: {
    title: { es: "Comparte tu enlace", en: "Share your link", fr: "Partagez votre lien" },
    todo: {
      es: "Compártelo donde ya estás: WhatsApp y grupos de Facebook. Así te encuentran.",
      ...
      es: "Ya tienes alumnos que llegaron por tu enlace. Sigue compartiéndolo.",
    ...
    cta: { es: "Comparte tu enlace", en: "Share your link", fr: "Partagez votre lien" },
    action: { kind: "share", channels: ["whatsapp", "facebook"] },
  },
  leads: {
    title: {
      es: "Atiende a los interesados",
      en: "Follow up with leads",
      fr: "Relancez les personnes intéressées",
    },
    // todo only shows when there's something pending (count > 0).
    todo: {
      es: "Tienes {n} mensaje{s} sin responder. Responde rápido: la velocidad convierte.",
    ...
    cta: { es: "Ver interesados", en: "View leads", fr: "Voir les intéressés" },
    action: { kind: "nav", nav: "leads" },
  },
};

// Render "{s}" plural markers: drop for n === 1, keep the letter otherwise.
// Handles both the es "reseña{s}" and en "testimonial{s}" forms.
...
const SHARE_TEXT: Record<ShareChannel, Copy> = {
  whatsapp: {
    es: "¡Hola! Reserva y paga tus clases conmigo aquí: {url}",
    en: "Hi! Book and pay for your classes with me here: {url}",
    fr: "Bonjour ! Réservez et payez vos cours avec moi ici : {url}",
  },
  facebook: {
    es: "Doy clases particulares y tengo cupo disponible. Puedes ver mis paquetes, horarios y reservar directo aquí 👇\n\n{url}\n\n¿Dudas? Escríbeme con gusto.",
